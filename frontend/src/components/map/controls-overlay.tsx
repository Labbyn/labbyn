...
function ControlHint({
  ...
  return (
    <div className="backdrop-blur-md bg-card/30 rounded-xl border border-border/40 text-card-foreground px-3 py-1.5 text-[10px] font-bold uppercase tracking-tight flex items-center gap-3 w-fit">
      {icon}
      {keys && (
