...
async def create_room(
    ...
    :return: Room object.
    """
    return await RoomService(ctx.db, ctx).create_room(room_data)
...
async def get_rooms(
    ...
    """
    return await RoomService(ctx.db, ctx).repo.get_all(ctx.db, ctx)
...
async def get_rooms_dashboard(
    ...
    :return: Room object.
    """
    return await RoomService(ctx.db, ctx).get_dashboard_list()
...
async def get_room_details(
    ...
    :return: Room object.
    """
    return await RoomService(ctx.db, ctx).get_detailed_room(room_id)
...
async def get_room_by_id(
    ...
    :return: Room object.
    """
    return await RoomService(ctx.db, ctx).get_room_or_404(room_id)
...
async def update_room(
    ...
    :return: Updated Room.
    """
    return await RoomService(ctx.db, ctx).update_room(room_id, room_data)
...
async def delete_room(
    ...
    """
    await RoomService(ctx.db, ctx).delete_room(room_id)
