...
async def create_category(
    ...
    """
    service = CategoryService(ctx.db, ctx)
...
async def update_category(
    ...
    """
    return await CategoryService(ctx.db, ctx).update_category(cat_id, cat_data)
...
async def delete_category(
    ...
    """
    await CategoryService(ctx.db, ctx).delete_category(cat_id)
