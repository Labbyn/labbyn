...
async def create_item(
    ...
    """
    return await InventoryService(db, ctx).create_item(inventory_data)
...
async def get_inventory(
    ...
    """
    return await InventoryService(db, ctx).repo.get_all(db, ctx)
...
async def get_inventory_item_details(
    ...
    """
    return await InventoryService(db, ctx).get_item_details(item_id)
...
async def get_inventory_item(
    ...
    :return: Inventory item.
    """
    return await InventoryService(db, ctx).get_inventory_or_404(item_id)
...
async def update_item(
    ...
    """
    return await InventoryService(db, ctx).update_item(item_id, item_data)
