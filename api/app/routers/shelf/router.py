...
async def get_shelves_by_rack(
    ...
    """
    return await ShelfService(ctx.db, ctx).list_by_rack(rack_id)
...
async def get_single_shelf(
    ...
    """
    return await ShelfService(ctx.db, ctx).get_shelf_or_404(shelf_id)
...
async def create_shelf(
    ...
    """
    return await ShelfService(ctx.db, ctx).create_shelf(rack_id, shelf_data)
...
async def update_shelf(
    ...
    """
    return await ShelfService(ctx.db, ctx).update_shelf(shelf_id, shelf_data)
...
async def delete_shelf(
    ...
    """
    await ShelfService(ctx.db, ctx).delete_shelf(shelf_id)
