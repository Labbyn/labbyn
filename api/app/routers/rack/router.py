...
async def get_racks(
    ...
    """
    return await RackService(ctx.db, ctx).get_all_racks(room_ids, team_ids)
...
async def get_racks_list(
    ...
    """
    ctx.require_user()
    service = RackService(ctx.db, ctx)
    racks = await service.repo.get_all(ctx.db, ctx)
...
async def get_rack_detail(
    ...
    """
    rack = await RackService(ctx.db, ctx).get_rack_or_404(rack_id, detailed=True)
...
async def create_rack(
    ...
    """
    return await RackService(ctx.db, ctx).create_rack(rack)
...
async def update_rack(
    ...
    """
    return await RackService(ctx.db, ctx).update_rack(rack_id, rack_data)
...
async def delete_rack(
    ...
    """
    await RackService(ctx.db, ctx).delete_rack(rack_id)
