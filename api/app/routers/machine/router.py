...
async def create_machine(
    ...
    """
    return await MachineService(db, ctx).create_machine(machine_data)
...
async def get_machines(
    ...
    """
    return await MachineService(db, ctx).repo.get_all(db, ctx)
...
async def get_machine_by_id(
    ...
    :return: Machine object.
    """
    return await MachineService(db, ctx).get_machine_or_404(machine_id)
...
async def get_machine_full_detail(
    ...
    :return: Machine object.
    """
    return await MachineService(db, ctx).get_full_detail(machine_id)
...
async def update_machine(
    ...
    """
    return await MachineService(db, ctx).update_machine(machine_id, machine_data)
...
async def delete_machine(
    ...
    :return: None.
    """
    await MachineService(db, ctx).delete_machine(machine_id)
...
async def mount_machine(
    ...
    """
    return await MachineService(db, ctx).mount_machine(machine_id, shelf_id)
...
async def unmount_machine(
    ...
    :return: Status message.
    """
    return await MachineService(db, ctx).unmount_machine(machine_id)
